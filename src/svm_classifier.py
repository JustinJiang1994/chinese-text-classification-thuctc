...
class SVMNewsClassifier:
    ...
    def create_classifier(self, C=1.0, max_iter=1000):
        ...
        self.classifier = LinearSVC(
            ...
            dual=False,             # 对于大数据集，使用primal形式更快
    ...
    def plot_confusion_matrix(self):
        ...
        plt.title('SVM分类器混淆矩阵', fontsize=16, fontweight='bold')
    ...
    def save_model(self, model_path='models/svm_model.pkl'):
        """保存模型"""
    ...
    def load_model(self, model_path='models/svm_model.pkl'):
        """加载模型"""
    ...
    def predict(self, texts):
        ...
        # 对于SVM，我们需要使用decision_function来获取置信度
        decision_scores = self.classifier.decision_function(X_vec)
        
        # 转换回类别名称
        predicted_classes = self.label_encoder.inverse_transform(predictions)
        
        return predicted_classes, decision_scores
