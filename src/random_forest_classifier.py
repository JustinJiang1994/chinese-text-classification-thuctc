...
class RandomForestNewsClassifier:
    ...
    def create_classifier(self, n_estimators=100, max_depth=None, min_samples_split=2):
        """创建随机森林分类器"""
        print("正在创建随机森林分类器...")
        ...
        self.classifier = RandomForestClassifier(
            ...
            min_samples_split=min_samples_split,  # 分裂所需的最小样本数
    ...
    def plot_confusion_matrix(self):
        ...
        plt.title('随机森林分类器混淆矩阵', fontsize=16, fontweight='bold')
        plt.xlabel('预测类别', fontsize=12)
        plt.ylabel('真实类别', fontsize=12)
        plt.xticks(rotation=45)
        plt.yticks(rotation=0)
        plt.tight_layout()
        plt.savefig('results/random_forest_confusion_matrix.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def plot_feature_importance(self, top_n=20):
        ...
        plt.xlabel('特征重要性')
        plt.title(f'随机森林分类器 - 前{top_n}个重要特征', fontsize=16, fontweight='bold')
        plt.gca().invert_yaxis()
        plt.tight_layout()
        plt.savefig('results/random_forest_feature_importance.png', dpi=300, bbox_inches='tight')
        plt.show()
