...
from random_forest_classifier import RandomForestNewsClassifier
...
def main():
    ...
    try:
        ...
        print("\n结果已保存到 results/random_forest_results.txt")
        print("混淆矩阵已保存到 results/random_forest_confusion_matrix.png")
        print("特征重要性图已保存到 results/random_forest_feature_importance.png")
        print("模型已保存到 models/random_forest_model.pkl")
