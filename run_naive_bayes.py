...
def main():
    ...
    try:
        ...
        # 保存结果到文件
        with open('results/naive_bayes_results.txt', 'w', encoding='utf-8') as f:
            f.write("朴素贝叶斯分类器结果\n")
            f.write("=" * 40 + "\n")
        ...
        print("\n结果已保存到 results/naive_bayes_results.txt")
        print("混淆矩阵已保存到 results/naive_bayes_confusion_matrix.png")
        print("模型已保存到 models/naive_bayes_model.pkl")
